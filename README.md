# CU01 V1.3 (Iniciar Sesión) + CU02 V1.4 (Registrar Queja, Reclamo, Denuncia o Sugerencia)

Aplicación web local con Java, Spring Boot y Thymeleaf. Implementa CU01 V1.3 y CU02 V1.4; los datos viven temporalmente en memoria.
...
La ruta `/` se deja libre para CU00. Ahora se ingresa primero por `/login`.

## Abrir y ejecutar en NetBeans

1. Abre NetBeans y selecciona **File > Open Project**.
2. Elige la carpeta `registro-caso-java` que contiene `pom.xml`.
3. Configura JDK 17 o superior si NetBeans lo solicita.
4. Clic derecho en el proyecto → **Run**.
5. Abre [http://localhost:8080/login](http://localhost:8080/login) e ingresa con alguno de los usuarios de prueba.
