...
public class RepositorioClientes {
    ...
    public Optional<Cliente> buscarPorId(String id) {
        ...
        if (jdbc != null) {
            return jdbc.query("SELECT id_usuario, nombre_completo, correo_electronico FROM usuario WHERE id_usuario=?", (rs, fila) -> {
                ...
                return new Cliente(String.valueOf(usuarioId), rs.getString("nombre_completo"), "", rs.getString("correo_electronico"), "", cuentas);
